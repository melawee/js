...
$(function() {
    ...
    $('.enable-animations').click(function(){
        ...
        $('#theme-animations').attr('href','fides/assets/themes/minified/fides/animations.min.css');
...
$(function(){
            ...
            $('#loading').slideDown({
                complete: function(){
                    ...
                    if ( layoutTheme != '' ) {
                        ...
                        $("#layout-theme").attr("href","fides/assets/themes/minified/fides/color-schemes/" + layoutTheme + ".min.css");
 ...
 function themefromCookie(){
 	...
 	if ( layoutThemefromCookie != null ) {
 		...
 		$("#layout-theme").attr("href","fides/assets/themes/minified/fides/color-schemes/" + layoutThemefromCookie + ".min.css");
